...
export const products: Product[] = [
  {
    ...
    originalPrice: 220,
    description:
      "Our flagship sun-dried sticky banana. Naturally sweet Mysore bananas, slow-dried to a chewy golden bite with no preservatives or added sugar.",
    shortDescription: "Flagship sun-dried sticky banana. Chewy, naturally sweet.",
    ...
    stock: 40,
    weight: "200g",
    tags: [...baseTags, "Best Seller", "Sun-Dried"],
    flavorProfile: "Sweet",
  ...
  },
  {
    ...
    name: "Dried Mango",
    price: 160,
    description: "Sweet and tangy sun-dried mango slices made from ripe Indian mangoes.",
    shortDescription: "Sweet and tangy sun-dried mango slices.",
  ...
  },
  {
    ...
    name: "Dried Banana",
    price: 150,
    description: "Classic crispy banana chips, naturally sweet and sun-dried.",
  ...
  },
  {
    ...
    name: "Dried Carrot",
    price: 155,
    description: "Earthy and sweet carrot coins, sun-dried for a satisfying crunch.",
  ...
  },
  {
    ...
    name: "Dried Chillies",
    price: 180,
    description: "Spicy and aromatic sun-dried chillies from Karnataka farms.",
    shortDescription: "Spicy and aromatic sun-dried chillies.",
