...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "Dried Mango",
    price: 160,
    description: "Sweet and tangy dehydrated mango slices made from ripe Indian mangoes. Naturally rich in Vitamin C and fiber. No added sugar, no preservatives.",
    shortDescription: "Sweet and tangy dehydrated mango slices.",
    benefit: "Vitamin C Rich",
  ...
  },
  {
    ...
    name: "Dried Beetroot",
    price: 165,
    description: "Rich in iron, vibrant beetroot crisps with an earthy sweetness.",
    shortDescription: "Rich in iron, vibrant and crisp.",
